    ...
    >
      <div className="homes-text">
        ...
        <p>
          ...
          <br />
          Overlooking the sprawling city, Hotel Pearl Karachi is a part of the most significant chain of hotels in Pakistan. 
          The Hotel is perfect for both business and leisure travelers. Guests can choose from a variety of rooms and suites 
          to enjoy their stay at the five-star hotel.
        </p>
        <Link href="#">
